...
export const ko: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      groupByProjectStatus: "프로젝트 및 상태별 그룹화",
  ...
  agentStream: {
    ...
    scheduledPromptUnavailable: "세션을 열었지만 예약된 프롬프트를 찾을 수 없습니다.",
  ...
  cockpit: {
    ...
    actions: {
      ...
      moveLeft: "카드를 왼쪽으로 이동",
      moveRight: "카드를 오른쪽으로 이동",
      moveUp: "카드를 위로 이동",
      moveDown: "카드를 아래로 이동",
      snooze: "잠시 미루기",
      wake: "다시 보기",
