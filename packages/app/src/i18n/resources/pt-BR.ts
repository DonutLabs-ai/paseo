...
export const ptBR: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      groupByProjectStatus: "Agrupar por projeto e status",
  ...
  cockpit: {
    ...
    actions: {
      ...
      moveLeft: "Mover cartão para a esquerda",
      moveRight: "Mover cartão para a direita",
      moveUp: "Mover cartão para cima",
  ...
  sidebar: {
    display: {
      ...
      grouping: {
        label: "Agrupamento",
        project: "Projeto",
        projectStatus: "Projeto e status",
        status: "Status",
        labels: "Etiquetas",
      },
      titleSource: {
  ...
  panels: {
    references: {
      label: "Referências",
      subtitle: "Threads do Slack e issues do Linear",
      tooltip: "Referências do workspace",
      disconnected: "Conecte-se a este host para carregar as referências do workspace.",
      scanning: "Verificando as sessões do workspace…",
      updated: "Atualizado em {{timestamp}}",
  ...
  settings: {
    ...
    host: {
      ...
      workspaceReferences: {
        ...
        tokenPlaceholder: "Token do {{provider}}",
        saving: "Salvando…",
        replace: "Substituir",
        connect: "Conectar",
        remove: "Remover",
