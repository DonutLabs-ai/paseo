...
export const es: TranslationResources = {
  ...
  cockpit: {
    ...
    actions: {
      ...
      moveLeft: "Mover tarjeta a la izquierda",
      moveRight: "Mover tarjeta a la derecha",
      moveUp: "Mover tarjeta hacia arriba",
    ...
    empty: {
      title: "No hay espacios de trabajo para mostrar",
      description: "Cambia los filtros de la barra lateral o crea un espacio de trabajo.",
      waitingForReply: "Esperando respuesta…",
      noActivity: "Aún no hay actividad del agente",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      confirmations: {
        ...
        archiveMessage: "Este espacio de trabajo se eliminará de los espacios de trabajo activos.",
        cancel: "Cancelar",
      },
      rename: {
        title: "Nota del espacio de trabajo",
        submit: "Guardar",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        archiveWorkspace: "Archivar espacio de trabajo",
        snoozeWorkspace: "Posponer o reactivar espacio de trabajo",
        newTab: "Nueva pestaña",
    ...
    host: {
      ...
      workspaceReferences: {
        ...
        slackGuide:
          "Crea una app de Slack y, en OAuth & Permissions, añade channels:history, groups:history, im:history, mpim:history y users:read a Bot Token Scopes. Instala o reinstala la app, pega aquí el token xoxb- e invita al bot a cada canal que deba leer. También funciona un token de usuario xoxp- con User Token Scopes equivalentes.",
