...
export const fr: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      groupByProjectStatus: "Grouper par projet et statut",
  ...
  agentStream: {
    ...
    scheduledPromptUnavailable:
      "La session est ouverte, mais son invite planifiée est introuvable.",
  ...
  cockpit: {
    ...
    actions: {
      ...
      moveLeft: "Déplacer la carte à gauche",
      moveRight: "Déplacer la carte à droite",
      moveUp: "Déplacer la carte vers le haut",
  ...
  sidebar: {
    display: {
      ...
      grouping: {
        label: "Regroupement",
        project: "Projet",
        projectStatus: "Projet et statut",
        status: "Statut",
        labels: "Libellés",
      },
      titleSource: {
